 ...
 */
public class BigPlaceItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BigPlaceItemAdapter(List<Object> items, MainActivity.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        switch(viewType) {
            ...
            case PLACE_ITEM_VIEW_TYPE:
                ...
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.big_place_item, parent, false);
